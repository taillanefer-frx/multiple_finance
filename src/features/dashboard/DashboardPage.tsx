  ...
  return (
    <div className="space-y-6 pb-2">
      ...
      <section className="rounded-3xl bg-petrol p-5 text-white shadow-lift sm:p-6">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2"><Button variant="secondary" className="border-white/15 bg-white/10 text-white hover:bg-white/15" disabled={!snapshot.personalReady} onClick={() => openNew('income')}><ArrowDownLeft size={16} /> Entrada</Button><Button className="bg-white text-petrol hover:bg-white/90" disabled={!snapshot.personalReady} onClick={() => openNew('expense')}><Plus size={16} /> Saída</Button></div>
      </section>
