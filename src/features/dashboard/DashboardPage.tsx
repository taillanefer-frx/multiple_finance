...
import { ArrowDownLeft, ArrowUpRight, CalendarDays, ChevronRight, Landmark, Pencil, Plus, ReceiptText, Scale, UsersRound, WalletCards } from 'lucide-react'
...
const demoSnapshot: PersonalFinanceSnapshot = {
  ...
  items: [
    { id: 'personal:demo-income', source: 'personal', sourceId: 'demo-income', type: 'income', description: 'Renda principal', amount: 4200, category: 'Salário', occurredOn: '2026-07-05', competenceMonth: '2026-07', notes: null, editable: true, groupId: null, groupName: null, expenseType: null },
    { id: 'personal:demo-market', source: 'personal', sourceId: 'demo-market', type: 'expense', description: 'Compras pessoais', amount: 320, category: 'Mercado', occurredOn: '2026-07-12', competenceMonth: '2026-07', notes: null, editable: true, groupId: null, groupName: null, expenseType: null },
    { id: 'group:demo-home', source: 'group', sourceId: 'demo-home', type: 'expense', description: 'Minha parte da casa', amount: 1428.9, category: 'Moradia', occurredOn: '2026-07-10', competenceMonth: '2026-07', notes: null, editable: false, groupId: demoGroups[0].id, groupName: demoGroups[0].name, expenseType: 'fixed' },
  ],
  categories: [
  ...
  return (
    <div className="space-y-6 pb-2">
      ...
      <section className="rounded-3xl bg-petrol p-5 text-white shadow-lift sm:p-6">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2"><Button variant="secondary" className="border-white/15 bg-white/10 text-white hover:bg-white/15" disabled={!snapshot.personalReady} onClick={() => openNew('income')}><ArrowDownLeft size={16} /> Entrada</Button><Button className="bg-rose-400 text-white hover:bg-rose-500 " disabled={!snapshot.personalReady} onClick={() => openNew('expense')}><Plus size={16} /> Saída</Button></div>
      </section>
